#!/usr/bin/env python3
import sys
sys.path.append('/mnt/disks/sdc/ashmit/Open-Assistant/model/')

# Need to call this before importing transformers.
from model_training.models.llama_flash_attn_monkey_patch import (
...
class SFTTrainer(Trainer):
    ...
    def _compute_loss(self, model, inputs):
        ...
        input= outputs.get("logits")
    
        

        return loss, input, targets, labels_mask
...
def argument_parsing(notebook=False, notebook_args=None):
    ...
    parser.add_argument("--show_dataset_stats", action="store_true", help="Show dataset stats", default=True)
...
def main():
    ...
    if training_conf.log_wandb and (not training_conf.deepspeed or training_conf.local_rank == 0):
        ...
        wandb.init(
            ...
            name= f"{wandb_name}-{training_conf.log_dir}-finetune",
