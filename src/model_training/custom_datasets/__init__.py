...
def get_one_dataset(
    ...
    **kwargs,
    ...
    elif dataset_name == "expressposter":
        dataset = ExpressPoster(cache_dir=data_path, **kwargs)
    elif dataset_name == "videollm":
        dataset = VideoLLM(cache_dir=data_path, **kwargs)
    elif dataset_name == "lamem":
        dataset = Lamem(cache_dir=data_path, **kwargs)
    elif dataset_name == "sun":
        dataset = SUN(cache_dir=data_path, **kwargs)
    elif dataset_name == "things":
        dataset = Memorability2(cache_dir=data_path, **kwargs)
    elif dataset_name == "memcat":
        dataset = Memcat(cache_dir=data_path, **kwargs)
    elif dataset_name == "memento":
        dataset = Memento(cache_dir=data_path, **kwargs)
    elif dataset_name == "videomem":
        dataset = VideoMem(cache_dir=data_path, **kwargs)
    elif dataset_name == "mediaeval":
        dataset = MediaEval(cache_dir=data_path, **kwargs)
    elif dataset_name == "study":
        dataset = AdStudy(cache_dir=data_path, **kwargs)
    elif dataset_name == "ytreplay10k":
        frames_path = f'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/frames_processed_masked_{conf.time}' if conf.mask["video"] else '/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/frames_processed' 
        
        dataset = YTReplay10k(data_path,'/mnt/disks/sdc/aditya/vidllm/Benchmark/train_split.csv','/mnt/disks/sdc/aditya/vidllm/Benchmark/processed_replay_graphs.json',"/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/blip2_deduplicated.json",'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/merged_ocr.json','/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/merged_asr.json',frames_path,'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/replay_video_metadata_vicuna10k.csv','/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/video_channel_name_subs.csv',time=conf.time,window_size=conf.window_size,mask_replay_graph=conf.mask["replay_graph"],mask_blip2=conf.mask["blip2"],mask_ocr = conf.mask["ocr"],mask_asr=conf.mask["asr"],mask_video = conf.mask["video"],mask_meta=conf.mask["meta"],**kwargs)
        
        # dataset_train = YTReplay10k(data_path,'/mnt/disks/sdc/aditya/vidllm/Benchmark/train_split.csv','/mnt/disks/sdc/aditya/vidllm/Benchmark/processed_replay_graphs.json',"/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/blip2_deduplicated.json",'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/merged_ocr.json','/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/merged_asr.json',frames_path,'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/replay_video_metadata_vicuna10k.csv','/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/video_channel_name_subs.csv',time=conf.time,window_size=conf.window_size,mask_replay_graph=conf.mask["replay_graph"],mask_blip2=conf.mask["blip2"],mask_ocr = conf.mask["ocr"],mask_asr=conf.mask["asr"],mask_video = conf.mask["video"],mask_meta=conf.mask["meta"],**kwargs)
        # dataset_test = YTReplay10k(data_path,'/mnt/disks/sdc/aditya/vidllm/Benchmark/test_split.csv','/mnt/disks/sdc/aditya/vidllm/Benchmark/processed_replay_graphs.json',"/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/blip2_deduplicated.json",'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/merged_ocr.json','/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/merged_asr.json',frames_path,'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/replay_video_metadata_vicuna10k.csv','/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/video_channel_name_subs.csv',time=conf.time,window_size=conf.window_size,mask_replay_graph=conf.mask["replay_graph"],mask_blip2=conf.mask["blip2"],mask_ocr = conf.mask["ocr"],mask_asr=conf.mask["asr"],mask_video = conf.mask["video"],mask_meta=conf.mask["meta"],**kwargs)
        
        # keys_train = dataset_train.keys
        # keys_test = dataset_test.keys
        
        # print('intersection !!!!!!!!!!!!!!!', set(keys_test).intersection(set(keys_train)))
    elif dataset_name == "ytreplay10kcombined":
        frames_path = f'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/frames_processed_masked_{conf.time}' if conf.mask["video"] else '/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/frames_processed' 
        
        dataset = YTReplay10kCombined(data_path,'/mnt/disks/sdc/aditya/vidllm/Benchmark/train_split.csv','/mnt/disks/sdc/aditya/vidllm/Benchmark/processed_replay_graphs.json',"/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/blip2_deduplicated.json",'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/merged_ocr.json','/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/merged_asr.json',frames_path,'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/replay_video_metadata_vicuna10k.csv','/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/video_channel_name_subs.csv',window_size=conf.window_size,mask_replay_graph=conf.mask["replay_graph"],mask_blip2=conf.mask["blip2"],mask_ocr = conf.mask["ocr"],mask_asr=conf.mask["asr"],mask_video = conf.mask["video"],mask_meta=conf.mask["meta"],**kwargs)
        
        # dataset = YTReplay10kCombined(data_path,'/mnt/disks/sdc/aditya/vidllm/Benchmark/train_split.csv','/mnt/disks/sdc/aditya/vidllm/Benchmark/processed_replay_graphs.json',"/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/blip2_deduplicated.json",'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/merged_ocr.json','/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/merged_asr.json',frames_path,'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/replay_video_metadata_vicuna10k.csv','/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/video_channel_name_subs.csv',time=conf.time,window_size=conf.window_size,mask_replay_graph=conf.mask["replay_graph"],mask_blip2=conf.mask["blip2"],mask_ocr = conf.mask["ocr"],mask_asr=conf.mask["asr"],mask_video = conf.mask["video"],mask_meta=conf.mask["meta"],**kwargs)
        # dataset = YTReplay10kCombined(data_path,'/mnt/disks/sdc/aditya/vidllm/Benchmark/test_split.csv','/mnt/disks/sdc/aditya/vidllm/Benchmark/processed_replay_graphs.json',"/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/blip2_deduplicated.json",'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/merged_ocr.json','/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/merged_asr.json',frames_path,'/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/replay_video_metadata_vicuna10k.csv','/mnt/disks/opt-3/sdc/ashmit/verbalizations/data/video_channel_name_subs.csv',time=conf.time,window_size=conf.window_size,mask_replay_graph=conf.mask["replay_graph"],mask_blip2=conf.mask["blip2"],mask_ocr = conf.mask["ocr"],mask_asr=conf.mask["asr"],mask_video = conf.mask["video"],mask_meta=conf.mask["meta"],**kwargs)
